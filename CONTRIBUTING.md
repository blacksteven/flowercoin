...
The FlowerCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the FlowerCoin Core project, and is not to be
confused with overall FlowerCoin Network Protocol consensus changes.

Whether a pull request is merged into FlowerCoin Core rests with the project merge
...
Patches that change FlowerCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the FlowerCoin consensus, it must have been
