...
Run FlowerCoin behind a Tor proxy
------------------------------------
...
```
./flowercoind -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=dnetzj6l4cvo2fxy.onion:989
```
...
Run a FlowerCoin hidden server
----------------------------------
...
your flowercoind's P2P listen port (9191 by default).
```
...
```
./flowercoind -proxy=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -listen
```
...
```
./flowercoind -onion=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -discover
```

List of known FlowerCoin Tor relays
------------------------------------
```
***TODO***
```
