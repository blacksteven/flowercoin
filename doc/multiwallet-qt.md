...
In order to support loading of multiple wallets in flowercoin-qt, a few changes in the UI architecture will be needed.
...
----------------------
flowercoin.cpp is the entry point into flowercoin-qt, and as such, will require some minor modifications to provide hooks for
