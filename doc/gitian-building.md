...
```bash
    ...
    From https://github.com/flowercoin/flowercoin
...
For example:
```bash
URL=https://github.com/konez2k/flowercoin.git
...
[flowercoin/gitian.sigs](https://github.com/flowercoin/gitian.sigs/) repository, or if that's not possible to create a pull
request.
