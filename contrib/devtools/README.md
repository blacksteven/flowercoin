...
flowercoin/flowercoin repository.
...
Setup
---------
Configuring the github-merge tool for the FlowerCoin repository is done in the following way:

    git config githubmerge.repository flowercoin/flowercoin
...
A script to optimize png files in the FlowerCoin
