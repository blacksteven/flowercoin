...
#   c) node1 mines 32 blocks, so now node 0 has 500000FLC, node 1 has 4250FLC, node2 has none.
#   d) node0 sends 601 FLC to node2, in two transactions (301 FLC, then 300 FLC).
