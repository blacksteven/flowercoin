...
#define NEWS_URL "https://rfc.flowercoin.org/category/news/feed/"
...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate() : QAbstractItemDelegate(), unit(BitcoinUnits::FLC)
    {
    }
                              ...
                              const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    CAmount flcAvailableBalance = balance - immatureBalance - nLockedBalance;

    // FLC Watch-Only Balance
    CAmount nTotalWatchBalance = watchOnlyBalance + watchUnconfBalance;
    CAmount nAvailableWatchBalance = watchOnlyBalance - watchImmatureBalance - nWatchOnlyLockedBalance;

    // FLC labels
    ui->labelBalance->setText(BitcoinUnits::floorHtmlWithUnit(nDisplayUnit, flcAvailableBalance, false, BitcoinUnits::separatorAlways));
    ...
    // FLC Available
    bool showFLCAvailable = settingShowAllBalances || flcAvailableBalance != nTotalBalance;
    bool showWatchOnlyFLCAvailable = showFLCAvailable || nAvailableWatchBalance != nTotalWatchBalance;
    ui->labelBalanceText->setVisible(showFLCAvailable || showWatchOnlyFLCAvailable);
    ui->labelBalance->setVisible(showFLCAvailable || showWatchOnlyFLCAvailable);
    ui->labelWatchAvailable->setVisible(showFLCAvailable && showWatchOnly);

    // FLC Pending
    bool showFLCPending = settingShowAllBalances || unconfirmedBalance != 0;
    bool showWatchOnlyFLCPending = showFLCPending || watchUnconfBalance != 0;
    ui->labelPendingText->setVisible(showFLCPending || showWatchOnlyFLCPending);
    ui->labelUnconfirmed->setVisible(showFLCPending || showWatchOnlyFLCPending);
    ui->labelWatchPending->setVisible(showFLCPending && showWatchOnly);
    ...
    // FLC Locked
    bool showFLCLocked = settingShowAllBalances || nLockedBalance != 0;
    bool showWatchOnlyFLCLocked = showFLCLocked || nWatchOnlyLockedBalance != 0;
    ui->labelLockedBalanceText->setVisible(showFLCLocked || showWatchOnlyFLCLocked);
    ui->labelLockedBalance->setVisible(showFLCLocked || showWatchOnlyFLCLocked);
    ui->labelWatchLocked->setVisible(showFLCLocked && showWatchOnly);
...
void OverviewPage::SetLinks()
{
    ...
    ui->labelLinks7->setText("FLC Merchants");

    ui->labelLinksUrl1->setText("<a href=\"https://www.flowercoin.org\">https://www.flowercoin.org</a>");
    ui->labelLinksUrl2->setText("<a href=\"https://flowercoin.org/go/whitepaper.pdf\">https://flowercoin.org/go/whitepaper.pdf</a>");
    ui->labelLinksUrl3->setText("<a href=\"http://explorer.flowercoin.online\">http://explorer.flowercoin.online</a>");
    ui->labelLinksUrl4->setText("<a href=\"https://flowercoin.org/go/discord\">https://flowercoin.org/go/discord</a>");
    ui->labelLinksUrl5->setText("<a href=\"https://flowercoin.org/go/twitter\">https://flowercoin.org/go/twitter</a>");
    ui->labelLinksUrl6->setText("<a href=\"https://github.com/flowercoin-official/flowercoin\">https://github.com/flowercoin-official/flowercoin</a>");
}
