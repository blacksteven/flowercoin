...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"flowercoin", "listmasternodes", &listmasternodes, true, true, false},
        {"flowercoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"flowercoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"flowercoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"flowercoin", "masternodedebug", &masternodedebug, true, true, false},
        {"flowercoin", "startmasternode", &startmasternode, true, true, false},
        {"flowercoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"flowercoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"flowercoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"flowercoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"flowercoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"flowercoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"flowercoin", "mnbudget", &mnbudget, true, true, false},
        {"flowercoin", "preparebudget", &preparebudget, true, true, false},
        {"flowercoin", "submitbudget", &submitbudget, true, true, false},
        {"flowercoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"flowercoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"flowercoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"flowercoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"flowercoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"flowercoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"flowercoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"flowercoin", "checkbudgets", &checkbudgets, true, true, false},
